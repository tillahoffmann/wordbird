...
class Overlay(Foundation.NSObject):
    ...
    def setup(self):
        ...
        for i in range(num_bars):
            ...
            bar = NSView.alloc().initWithFrame_(((bx, by + max_bar_h / 2 - 1), (bar_w, 2)))
        ...
        self._stop_button.setImage_(_sf_image("xmark.circle.fill", size=14, color=_rgb(180, 180, 180)))
